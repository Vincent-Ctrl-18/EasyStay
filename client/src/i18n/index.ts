...
const translations: Record<Language, Record<string, string | string[]>> = {
  zh: {
    ...
    'search.roomGuest': '房间·住客',
    'search.rooms': '{n}间',
    'search.adults': '{n}位成人',
    'search.roomCount': '房间数',
    'search.adultCount': '成人数',
    ...
    'detail.nightUnit': '晚',
    'detail.roomUnit': '间',
    'detail.adultUnit': '位成人',
    'detail.priceBreakdown': '¥{price} × {nights}晚 × {rooms}间',
    'detail.bookNow': '立即预订',
    'detail.bookSuccess': '预订成功！',
    'detail.bookSuccessMsg': '您已成功预订 {hotel} 的 {room}',
    'detail.orderDetail': '订单详情',
    'detail.roomType': '房型',
    'detail.dateRange': '日期',
    'detail.nightCount': '晚数',
    'detail.roomCountLabel': '房间',
    'detail.guestCount': '住客',
    'detail.unitPrice': '单价',
    'detail.totalAmount': '合计',
    'detail.bookConfirm': '确认预订',
    'detail.backToHome': '返回首页',
    'detail.topChoice': '精选',
    'detail.excellent': '超赞',
    'detail.reviews': '({n}条评论)',
    'detail.showLess': '收起',
    'detail.showOnMap': '在地图上查看',
    'detail.upTo': '最多{n}人',
    ...
    'admin.register.inviteCodeRequired': '请输入管理员邀请码',
    'admin.register.inviteCodePlaceholder': '管理员邀请码',
    ...
    'admin.hotelForm.hotelImagesHint': '支持 JPG/PNG/WebP/GIF，最多上传 10 张',
  ...
  en: {
    ...
    'search.roomGuest': 'Room · Guests',
    'search.rooms': '{n} Room',
    'search.adults': '{n} Adults',
    'search.roomCount': 'Rooms',
    'search.adultCount': 'Adults',
    ...
    'list.modifySearch': 'Modify Search',
    'list.filterTitle': 'Filters',
    'list.filterApply': 'Apply',
    'list.filterReset': 'Reset',
    ...
    'detail.nightUnit': ' nights',
    'detail.roomUnit': ' room(s)',
    'detail.adultUnit': ' adult(s)',
    'detail.priceBreakdown': '¥{price} × {nights} nights × {rooms} rooms',
    'detail.bookNow': 'Book Now',
    'detail.bookSuccess': 'Booking Confirmed!',
    'detail.bookSuccessMsg': 'You have booked {room} at {hotel}',
    'detail.orderDetail': 'Order Details',
    'detail.roomType': 'Room Type',
    'detail.dateRange': 'Dates',
    'detail.nightCount': 'Nights',
    'detail.roomCountLabel': 'Rooms',
    'detail.guestCount': 'Guests',
    'detail.unitPrice': 'Unit Price',
    'detail.totalAmount': 'Total',
    'detail.bookConfirm': 'Confirm Booking',
    'detail.backToHome': 'Back to Home',
    'detail.topChoice': 'Top Choice',
    'detail.excellent': 'Excellent',
    ...
    'admin.register.inviteCodeRequired': 'Please enter admin invite code',
    'admin.register.inviteCodePlaceholder': 'Admin invite code',
    ...
    'admin.hotelForm.hotelImagesHint': 'Supports JPG/PNG/WebP/GIF, max 10 images',
